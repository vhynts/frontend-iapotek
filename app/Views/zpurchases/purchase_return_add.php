                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body px">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm m-1 rounded-3 border">
                                    <div class="mb-1 mt-1">
                                        ...
                                        <label for="pesanan" class="form-label">No Faktur Penjualan</label>
                                        ...
                                        <div class="row">
                                            <div class="mb-1 col-sm-12">
                                                ...
                                                <input type="text" class="form-control" id="jt" value="PROSES" disabled>
                                            </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="table-responsive p-0 mt-3 text-nowrap">
                                        <table class=" table table-striped mb-0 w-100">
                                            <thead class="table-secondary" style="padding: 10px;">
                                                <tr>
                                                    ...
                                                    <th style="font-size: 12px;">QTY RET</th>
                                                    <th style="font-size: 12px;">UNIT RET</th>
                                                    <th style="font-size: 12px;">SUB TOTAL RET</th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <th scope=" row">1</th>
                                                    <!-- <td>10013164</td> -->
                                                    <td class="col w-2 p-1" style="width: 25%;">
                                                        <div class=" input-group mb-1">

                                                            <input type="text" class="form-control" id="example-disable" value="">

                                                    </td>
                                                    <td class="col-sm-1 p-1" style=" width: 8%;">

                                                        <input type="number" class="form-control" id="qty" value="11" disabled>
                                                    </td>


                                                    <td class="col-sm-2 p-1" style=" width: 10%;">

                                                        <input type="text" class="form-control" id="unit" value="BOX" disabled>

                                                    </td>
                                                    <td class="col-sm-2 p-1" style=" width: 12%;">

                                                        <input type="number" class="form-control" id="harga" value="0" disabled>
                                                    </td>
                                                    <td class="col-sm-2 p-1" style=" width: 12%;">

                                                        <input type="number" class="form-control" id="harga2" value="0" disabled>
                                                    </td>
                                                    <td class="col-sm-1 p-1" style=" width: 8%;">
