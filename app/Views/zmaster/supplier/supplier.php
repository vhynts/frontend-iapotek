    ...
    <div class="content">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-sm">
                    <a href="supplier-add" class="btn btn-primary  float-end mb-2 mt-2"><i class="bi bi-plus-circle"></i> &nbsp; Tambah Supplier</a>
                </div>
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <table id="table-supplier" class="table table-striped dt-responsive nowrap w-100">
