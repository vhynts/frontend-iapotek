    ...
    <div class="content">
        ...
        <div class="container-fluid">
            ...
            <div class=" row">
                ...
                <div class="col-sm">
                    <a href="<?= base_url('purchase-return/create') ?>" class="btn btn-primary  float-end mb-2 mt-2"><i class="bi bi-plus-circle"></i> &nbsp; Tambah Retur Pembelian</a>
                </div>
                <!-- <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="tables" class="table table-striped table-centered mb-0">
...
<script src="<?= base_url('assets/js/vendor/buttons.excel.min.js'); ?>"></script>
