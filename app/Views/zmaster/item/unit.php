        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-sm">
                    ...
                    <button type="button" class="btn btn-primary float-end mb-2 mt-2" data-bs-toggle="modal" data-bs-target="#myModal"><i class="bi bi-plus-circle"></i> Tambah Satuan</button>
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myModalLabel">Tambah Satuan</h5>
