                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm m-1  rounded-3">
                                        ...
                                        <div class="row mb-2 mt-1   ">
                                            <label class="col-sm-3 col-form-label" for="grup-pelanggan">Grup Pelanggan</label>
                                            <div class="col-md">
                                        ...
                                        <div class="row mb-2">
                                            <label class="col-sm-3 col-form-label" for="tipe-potongan">Tipe Potongan</label>
                                            <div class="col-md">
                                                <select class="form-control select2" data-toggle="select2">
                                                    <option>-</option>
                                        ...
                                        <div class="row mb-2 mt-1   ">
                                            <label class="col-sm-3 col-form-label" for="wilayah">Wilayah</label>
                                            <div class="col-md">
                                                <select class="form-control select2" data-toggle="select2">
                                                    <option>-</option>
                                        ...
                                        <div class="row mb-2">
                                            <label class="col-sm-3 col-form-label" for="sub-wialyah">Sub Wilayah</label>
                                            <div class="col-md">
                                                <select class="form-control select2" data-toggle="select2">
                                                    <option>-</option>
